...
class DriverDocket(models.Model):
    ...
    waitingTimeStart = models.TimeField(null=True,blank=True)
    waitingTimeEnd = models.TimeField(null=True,blank=True)
    ...
    standByStartTime = models.TimeField(null=True,blank=True)
    standByEndTime = models.TimeField(null=True,blank=True)
