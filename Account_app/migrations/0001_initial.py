    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shiftDate', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 35, 941463, tzinfo=datetime.timezone.utc), null=True)),
                ...
                ('returnKm', models.FloatField(default=0)),
                ('waitingTimeStart', models.TimeField(blank=True, null=True)),
                ('waitingTimeEnd', models.TimeField(blank=True, null=True)),
                ...
                ('surcharge_duration', models.FloatField(default=0)),
                ('cubicMl', models.FloatField(default=0)),
                ('standByStartTime', models.TimeField(blank=True, null=True)),
                ('standByEndTime', models.TimeField(blank=True, null=True)),
