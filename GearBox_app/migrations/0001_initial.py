<<<<<<< HEAD
# Generated by Django 4.2.2 on 2023-10-23 04:42
=======
# Generated by Django 4.2.1 on 2023-10-23 05:52
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
...
<<<<<<< HEAD
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 179051, tzinfo=datetime.timezone.utc))),
=======
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 602034, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_load_in_cubic_meters_trip', models.FloatField(default=0)),
<<<<<<< HEAD
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 177544, tzinfo=datetime.timezone.utc))),
=======
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 598346, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
...
<<<<<<< HEAD
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 182570, tzinfo=datetime.timezone.utc))),
=======
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 605390, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
...
<<<<<<< HEAD
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 180056, tzinfo=datetime.timezone.utc))),
=======
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 604333, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
...
<<<<<<< HEAD
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 170003, tzinfo=datetime.timezone.utc))),
=======
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 593359, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
...
<<<<<<< HEAD
                ('clientTruckId', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(999999)])),
                ('startDate', models.DateField(default=datetime.datetime(2023, 10, 23, 4, 42, 40, 184575, tzinfo=datetime.timezone.utc))),
=======
                ('clientTruckId', models.PositiveIntegerField(default=0)),
                ('startDate', models.DateField(default=datetime.datetime(2023, 10, 23, 5, 52, 56, 610381, tzinfo=datetime.timezone.utc))),
>>>>>>> 03e93da56e8bd318afdf42c9172a20ec66a9f459
