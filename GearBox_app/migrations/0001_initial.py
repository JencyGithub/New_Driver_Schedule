# Generated by Django 4.2.1 on 2023-11-01 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 419150, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_load_in_cubic_meters_return_to_yard', models.FloatField(default=0)),
                ('return_load_grace', models.FloatField(default=1)),
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 417797, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 421942, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 420539, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 416348, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 11, 1, 4, 49, 11, 426144, tzinfo=datetime.timezone.utc))),
