# Generated by Django 4.2.1 on 2023-11-21 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 456556, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 18, 7, 9, 40, 456614, tzinfo=datetime.timezone.utc), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_to_yard_grace', models.FloatField(default=0)),
                ('return_to_tipping_grace', models.FloatField(default=0)),
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 455558, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 18, 7, 9, 40, 455558, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 458608, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 18, 7, 9, 40, 458608, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 457610, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 18, 7, 9, 40, 457610, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 454448, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 18, 7, 9, 40, 454448, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 11, 21, 7, 9, 40, 462536, tzinfo=datetime.timezone.utc))),
