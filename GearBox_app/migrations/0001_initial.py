    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 20, 18, 50, 33, 233258, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(default=datetime.datetime(2033, 10, 7, 18, 50, 33, 233258, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_load_in_cubic_meters_return_to_yard', models.FloatField(default=0)),
                ('min_load_in_cubic_meters_trip', models.FloatField(default=0)),
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 20, 18, 50, 33, 231258, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(default=datetime.datetime(2033, 10, 7, 18, 50, 33, 231258, tzinfo=datetime.timezone.utc))),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 20, 18, 50, 33, 234263, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(default=datetime.datetime(2033, 10, 7, 18, 50, 33, 234263, tzinfo=datetime.timezone.utc))),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 10, 20, 18, 50, 33, 230210, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(default=datetime.datetime(2033, 10, 7, 18, 50, 33, 230210, tzinfo=datetime.timezone.utc))),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('truckType', models.CharField(default='Embedded', max_length=254)),
                ('clientTruckId', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(999999)])),
                ('startDate', models.DateField(default=datetime.datetime(2023, 10, 20, 18, 50, 33, 238188, tzinfo=datetime.timezone.utc))),
