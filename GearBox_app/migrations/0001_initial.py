# Generated by Django 4.2.2 on 2023-11-13 04:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 13, 4, 8, 35, 833915, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_to_yard_grace', models.FloatField(default=0)),
                ('return_to_tipping_grace', models.FloatField(default=0)),
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 13, 4, 8, 35, 832918, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 13, 4, 8, 35, 834911, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 11, 13, 4, 8, 35, 835908, tzinfo=datetime.timezone.utc))),
