# Generated by Django 4.2.2 on 2023-11-24 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 24, 9, 52, 10, 400263, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 21, 9, 52, 10, 400263, tzinfo=datetime.timezone.utc), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_to_yard_grace', models.FloatField(default=0)),
                ('return_to_tipping_grace', models.FloatField(default=0)),
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 24, 9, 52, 10, 399264, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 21, 9, 52, 10, 399264, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.datetime(2023, 11, 24, 9, 52, 10, 401344, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateField(blank=True, default=datetime.datetime(2033, 11, 21, 9, 52, 10, 401344, tzinfo=datetime.timezone.utc), null=True)),
                ('rate_card_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GearBox_app.ratecard')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 11, 24, 9, 52, 10, 402916, tzinfo=datetime.timezone.utc))),
